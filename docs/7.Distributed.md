...
Ở bài hướng dẫn này, tôi đã theo dõi [Active check](3.Active-check.md) với YouTube trên `site-hanoi` và Facebook trên `site-hcm`. Và trên 2 site này, tôi cũng thêm 1 [user](5.Send-Noitify.md#22) tương ứng với các site là `user-hanoi` và `user-hcm`.
