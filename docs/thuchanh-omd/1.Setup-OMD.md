...
- [5. Đặt ngưỡng cảnh báo cho dịch vụ](#5)
...
<a name="4"></a>
### 4. Thêm dịch vụ giám sát Active Checks 
...
<a name="5"></a>
### 5. Đặt ngưỡng cảnh báo cho dịch vụ
...
Sau khi đặt ngưỡng cảnh báo xong, bây giờ chúng ta sẽ đi đến phần cấu hình cho OMD có thể gửi mail cảnh báo khi host/services gặp sự cố hoặc vượt ngưỡng vừa set. *[Bài chi tiết](2.Send-Noitify.md)*
