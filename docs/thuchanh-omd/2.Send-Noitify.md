...
Tối thiểu, chúng ta phải tạo 2 nhóm để có thể kiểm tra tính năng này. Ở phần trên, tôi đã hướng dẫn các bạn tạo mới một **User** là `user1` nằm trong **Group** có tên là `group1`. Để xem lại, vui lòng tham khảo phần tạo [Group](#21) và thêm [User vào Group](#22) để tạo mới một **group** thứ hai là `group2` và **user** có tên là `user2`.
